.class public Lcom/jmatio/io/MatFileWriter;
...
.method public constructor <init>(Ljava/io/File;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0, p2}, Lcom/jmatio/io/MatFileWriter;-><init>(Ljava/nio/channels/WritableByteChannel;Ljava/util/Collection;)V
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0, p2}, Lcom/jmatio/io/MatFileWriter;-><init>(Ljava/io/File;Ljava/util/Collection;)V

    return-void
.end method

.method public constructor <init>(Ljava/nio/channels/WritableByteChannel;Ljava/util/Collection;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Lcom/jmatio/io/MatFileWriter;->write(Ljava/nio/channels/WritableByteChannel;Ljava/util/Collection;)V

    return-void
.end method

.method private declared-synchronized write(Ljava/nio/channels/WritableByteChannel;Ljava/util/Collection;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/jmatio/io/MatFileWriter;->writeHeader(Ljava/nio/channels/WritableByteChannel;)V
    ...
    invoke-direct {p0, v3, v0}, Lcom/jmatio/io/MatFileWriter;->writeMatrix(Ljava/io/DataOutputStream;Lcom/jmatio/types/MLArray;)V
    ...
    invoke-direct {v5, v3, v0}, Ljava/util/zip/DeflaterOutputStream;-><init>(Ljava/io/OutputStream;Ljava/util/zip/Deflater;)V
...
.method private writeMatrix(Ljava/io/DataOutputStream;Lcom/jmatio/types/MLArray;)V
    ...
    invoke-direct {p0, v3, p2}, Lcom/jmatio/io/MatFileWriter;->writeFlags(Ljava/io/DataOutputStream;Lcom/jmatio/types/MLArray;)V

    invoke-direct {p0, v3, p2}, Lcom/jmatio/io/MatFileWriter;->writeDimensions(Ljava/io/DataOutputStream;Lcom/jmatio/types/MLArray;)V

    invoke-direct {p0, v3, p2}, Lcom/jmatio/io/MatFileWriter;->writeName(Ljava/io/DataOutputStream;Lcom/jmatio/types/MLArray;)V
...
# virtual methods
.method public declared-synchronized write(Ljava/io/File;Ljava/util/Collection;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, v0, p2}, Lcom/jmatio/io/MatFileWriter;->write(Ljava/nio/channels/WritableByteChannel;Ljava/util/Collection;)V
    :try_end_1
...
.method public declared-synchronized write(Ljava/lang/String;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p2}, Lcom/jmatio/io/MatFileWriter;->write(Ljava/io/File;Ljava/util/Collection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
