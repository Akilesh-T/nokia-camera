...
.method private attachListener(Lcom/facebook/appevents/codeless/CodelessMatcher$MatchedView;Landroid/view/View;Lcom/facebook/appevents/codeless/internal/EventBinding;)V
    ...
    .line 461
    invoke-static {v8}, Lcom/facebook/appevents/codeless/internal/ViewHierarchy;->findRCTRootView(Landroid/view/View;)Landroid/view/View;

    move-result-object v0

    .line 462
    .local v0, "RCTRootView":Landroid/view/View;
    if-eqz v0, :cond_2

    invoke-static {v8, v0}, Lcom/facebook/appevents/codeless/internal/ViewHierarchy;->isRCTButton(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 463
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/facebook/appevents/codeless/CodelessMatcher$ViewMatcher;->attachRCTListener(Lcom/facebook/appevents/codeless/CodelessMatcher$MatchedView;Landroid/view/View;Landroid/view/View;Lcom/facebook/appevents/codeless/internal/EventBinding;)V
    :try_end_0
    ...
    .line 491
    .end local v0    # "RCTRootView":Landroid/view/View;
    ...
    const-string v10, "Failed to attach auto logging event listener."
    ...
    .line 468
    .end local v4    # "e":Lcom/facebook/FacebookException;
    .restart local v0    # "RCTRootView":Landroid/view/View;
    ...
    .line 474
    .local v7, "mapKey":Ljava/lang/String;
    invoke-static {v8}, Lcom/facebook/appevents/codeless/internal/ViewHierarchy;->getExistingDelegate(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;

    move-result-object v5

    .line 475
    .local v5, "existingDelegate":Landroid/view/View$AccessibilityDelegate;
    if-eqz v5, :cond_4

    move v2, v3

    .line 476
    .local v2, "delegateExists":Z
    :goto_1
    if-eqz v2, :cond_5

    instance-of v10, v5, Lcom/facebook/appevents/codeless/CodelessLoggingEventListener$AutoLoggingAccessibilityDelegate;
    ...
    .line 478
    .local v6, "isCodelessDelegate":Z
    :goto_2
    if-eqz v6, :cond_6

    check-cast v5, Lcom/facebook/appevents/codeless/CodelessLoggingEventListener$AutoLoggingAccessibilityDelegate;

    .line 481
    .end local v5    # "existingDelegate":Landroid/view/View$AccessibilityDelegate;
    invoke-virtual {v5}, Lcom/facebook/appevents/codeless/CodelessLoggingEventListener$AutoLoggingAccessibilityDelegate;->getSupportCodelessLogging()Z
    ...
    .line 482
    .local v3, "delegateSupportCodelessLogging":Z
    :goto_3
    iget-object v9, p0, Lcom/facebook/appevents/codeless/CodelessMatcher$ViewMatcher;->delegateMap:Ljava/util/HashMap;
    ...
    .line 486
    :cond_3
    invoke-static {p3, p2, v8}, Lcom/facebook/appevents/codeless/CodelessLoggingEventListener;->getAccessibilityDelegate(Lcom/facebook/appevents/codeless/internal/EventBinding;Landroid/view/View;Landroid/view/View;)Lcom/facebook/appevents/codeless/CodelessLoggingEventListener$AutoLoggingAccessibilityDelegate;

    move-result-object v1

    .line 488
    .local v1, "delegate":Landroid/view/View$AccessibilityDelegate;
    ...
    .end local v1    # "delegate":Landroid/view/View$AccessibilityDelegate;
    .end local v2    # "delegateExists":Z
    .end local v3    # "delegateSupportCodelessLogging":Z
    .end local v6    # "isCodelessDelegate":Z
    .restart local v5    # "existingDelegate":Landroid/view/View$AccessibilityDelegate;
    :cond_4
    move v2, v9
    ...
    .restart local v2    # "delegateExists":Z
    :cond_5
    move v6, v9
    ...
    .end local v5    # "existingDelegate":Landroid/view/View$AccessibilityDelegate;
    .restart local v6    # "isCodelessDelegate":Z
    :cond_6
    move v3, v9
...
.method private attachRCTListener(Lcom/facebook/appevents/codeless/CodelessMatcher$MatchedView;Landroid/view/View;Landroid/view/View;Lcom/facebook/appevents/codeless/internal/EventBinding;)V
    ...
    invoke-static {v6, p3}, Lcom/facebook/appevents/codeless/internal/ViewHierarchy;->isRCTButton(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 521
    :cond_2
    invoke-static {p4, p2, v6}, Lcom/facebook/appevents/codeless/RCTCodelessLoggingEventListener;->getOnTouchListener(Lcom/facebook/appevents/codeless/internal/EventBinding;Landroid/view/View;Landroid/view/View;)Lcom/facebook/appevents/codeless/RCTCodelessLoggingEventListener$AutoLoggingOnTouchListener;
