.class Lcom/android/camera/one/v2/SimpleOneCameraFactory$2$3;
...
# direct methods
.method constructor <init>(Lcom/android/camera/one/v2/SimpleOneCameraFactory$2;Lcom/android/camera/async/Observable;Lcom/android/camera/one/v2/photo/PictureTakerFactory;)V
    .locals 0
    .param p1, "this$1"    # Lcom/android/camera/one/v2/SimpleOneCameraFactory$2;

    .prologue
    .line 572
    iput-object p1, p0, Lcom/android/camera/one/v2/SimpleOneCameraFactory$2$3;->this$1:Lcom/android/camera/one/v2/SimpleOneCameraFactory$2;

    iput-object p2, p0, Lcom/android/camera/one/v2/SimpleOneCameraFactory$2$3;->val$hdrSceneSetting:Lcom/android/camera/async/Observable;

    iput-object p3, p0, Lcom/android/camera/one/v2/SimpleOneCameraFactory$2$3;->val$pictureTakerFactory:Lcom/android/camera/one/v2/photo/PictureTakerFactory;
...
.method public run()V
    ...
    iget-object v2, p0, Lcom/android/camera/one/v2/SimpleOneCameraFactory$2$3;->val$hdrSceneSetting:Lcom/android/camera/async/Observable;
    ...
    :cond_0
    :goto_0
    iget-object v2, p0, Lcom/android/camera/one/v2/SimpleOneCameraFactory$2$3;->val$pictureTakerFactory:Lcom/android/camera/one/v2/photo/PictureTakerFactory;
