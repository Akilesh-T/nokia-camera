.class Lcom/android/camera/one/v2/Level3OneCameraFactory$1;
...
# direct methods
.method constructor <init>(Lcom/android/camera/one/v2/Level3OneCameraFactory;Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;)V
    .locals 0
    .param p1, "this$0"    # Lcom/android/camera/one/v2/Level3OneCameraFactory;

    .prologue
    .line 200
    iput-object p1, p0, Lcom/android/camera/one/v2/Level3OneCameraFactory$1;->this$0:Lcom/android/camera/one/v2/Level3OneCameraFactory;

    iput-object p2, p0, Lcom/android/camera/one/v2/Level3OneCameraFactory$1;->val$slaveCameraDevice:Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;

    iput-object p3, p0, Lcom/android/camera/one/v2/Level3OneCameraFactory$1;->val$device:Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;
...
.method public close()V
    ...
    iget-object v3, p0, Lcom/android/camera/one/v2/Level3OneCameraFactory$1;->val$slaveCameraDevice:Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;

    if-eqz v3, :cond_0

    .line 206
    new-instance v3, Lcom/android/camera/one/v2/Level3OneCameraFactory$1$1;

    invoke-direct {v3, p0, v0}, Lcom/android/camera/one/v2/Level3OneCameraFactory$1$1;-><init>(Lcom/android/camera/one/v2/Level3OneCameraFactory$1;Lcom/google/common/util/concurrent/SettableFuture;)V
    ...
    .line 226
    iget-object v3, p0, Lcom/android/camera/one/v2/Level3OneCameraFactory$1;->val$device:Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;
