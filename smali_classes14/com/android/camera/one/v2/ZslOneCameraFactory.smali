.class public Lcom/android/camera/one/v2/ZslOneCameraFactory;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "ZslOneCamFactory"

    invoke-direct {v0, v1}, Lcom/android/camera/debug/Log$Tag;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->TAG:Lcom/android/camera/debug/Log$Tag;
...
.method public constructor <init>(IILcom/android/camera/one/v2/photo/ImageRotationCalculator;Lcom/android/camera/one/v2/photo/ImageRotationCalculator;)V
    ...
    .line 142
    iput p1, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mImageFormat:I

    .line 143
    iput p2, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mMaxImageCount:I

    .line 144
    iput-object p3, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mImageRotationCalculator:Lcom/android/camera/one/v2/photo/ImageRotationCalculator;

    .line 145
    iput-object p4, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mSlaveImageRotationCalculator:Lcom/android/camera/one/v2/photo/ImageRotationCalculator;
    ...
    sget-object v1, Lcom/android/camera/one/v2/ZslOneCameraFactory;->TAG:Lcom/android/camera/debug/Log$Tag;
    ...
    iput-object v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mLogger:Lcom/android/camera/debug/Logger;
    ...
    iput-object v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->maxRingBufferSize:Lcom/android/camera/async/ConcurrentState;
...
.method static synthetic access$000()Lcom/android/camera/debug/Log$Tag;
    ...
    .prologue
    .line 130
    sget-object v0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->TAG:Lcom/android/camera/debug/Log$Tag;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/camera/one/v2/ZslOneCameraFactory;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;

    .prologue
    .line 130
    iget v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mImageFormat:I

    return v0
.end method

.method static synthetic access$200(Lcom/android/camera/one/v2/ZslOneCameraFactory;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;

    .prologue
    .line 130
    iget v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mMaxImageCount:I

    return v0
.end method

.method static synthetic access$300(Lcom/android/camera/one/v2/ZslOneCameraFactory;)Lcom/android/camera/debug/Logger;
    .locals 1
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mLogger:Lcom/android/camera/debug/Logger;

    return-object v0
.end method

.method static synthetic access$400(Lcom/android/camera/one/v2/ZslOneCameraFactory;)Lcom/android/camera/async/ConcurrentState;
    .locals 1
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->maxRingBufferSize:Lcom/android/camera/async/ConcurrentState;

    return-object v0
.end method

.method static synthetic access$500(Lcom/android/camera/one/v2/ZslOneCameraFactory;Lcom/android/camera/one/v2/core/RequestTemplate;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;
    ...
    .prologue
    .line 130
    invoke-direct {p0, p1}, Lcom/android/camera/one/v2/ZslOneCameraFactory;->applyNexus5BackCameraFrameRateWorkaround(Lcom/android/camera/one/v2/core/RequestTemplate;)V

    return-void
.end method

.method static synthetic access$600(Lcom/android/camera/one/v2/ZslOneCameraFactory;)Lcom/android/camera/one/v2/photo/ImageRotationCalculator;
    .locals 1
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mImageRotationCalculator:Lcom/android/camera/one/v2/photo/ImageRotationCalculator;

    return-object v0
.end method

.method static synthetic access$700(Lcom/android/camera/one/v2/ZslOneCameraFactory;)Lcom/android/camera/one/v2/photo/ImageRotationCalculator;
    .locals 1
    .param p0, "x0"    # Lcom/android/camera/one/v2/ZslOneCameraFactory;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mSlaveImageRotationCalculator:Lcom/android/camera/one/v2/photo/ImageRotationCalculator;
...
.method private applyNexus5BackCameraFrameRateWorkaround(Lcom/android/camera/one/v2/core/RequestTemplate;)V
    ...
    iget-object v1, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory;->mLogger:Lcom/android/camera/debug/Logger;
...
.method public createOneCamera(Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;Lcom/android/camera/one/OneCameraCharacteristics;Lcom/android/camera/one/OneCameraCharacteristics;Lcom/android/camera/one/config/OneCameraFeatureConfig$CaptureSupportLevel;Lcom/android/camera/async/MainThread;Lcom/android/camera/one/v2/imagesaver/ImageSaver$Builder;Lcom/android/camera/one/v2/imageprocessor/ImageProcessor$Builder;Lcom/android/camera/FatalErrorHandler;)Lcom/android/camera/one/OneCamera;
    ...
    new-instance v4, Lcom/android/camera/one/v2/ZslOneCameraFactory$1;
    ...
    invoke-direct {v4, v0, v1, v2}, Lcom/android/camera/one/v2/ZslOneCameraFactory$1;-><init>(Lcom/android/camera/one/v2/ZslOneCameraFactory;Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;Lcom/android/camera/one/v2/camera2proxy/CameraDeviceProxy;)V
    ...
    new-instance v3, Lcom/android/camera/one/v2/ZslOneCameraFactory$2;
