.class public Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;
.super Ljava/lang/Object;
.source "BeautyPictureTakerFactory.java"
...
.method private constructor <init>(Lcom/android/camera/one/v2/photo/PictureTakerImpl;Lcom/android/camera/one/v2/photo/SceneDetector;Lcom/android/camera/one/v2/photo/FlashDetector;)V
    ...
    .line 56
    iput-object p1, p0, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;->mPictureTaker:Lcom/android/camera/one/v2/photo/PictureTakerImpl;

    .line 57
    iput-object p2, p0, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;->mSceneDetector:Lcom/android/camera/one/v2/photo/SceneDetector;

    .line 58
    iput-object p3, p0, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;->mFlashDetector:Lcom/android/camera/one/v2/photo/FlashDetector;
...
.method public static create(Lcom/android/camera/debug/Logger$Factory;Lcom/android/camera/async/MainThread;Lcom/android/camera/one/OneCameraCharacteristics;Lcom/android/camera/one/v2/commands/CameraCommandExecutor;Lcom/android/camera/one/v2/imagesaver/ImageSaver$Builder;Lcom/android/camera/one/v2/imageprocessor/ImageProcessor$Builder;Lcom/android/camera/one/v2/core/FrameServer;Lcom/android/camera/one/v2/autofocus/ManualAutoFocus;Lcom/android/camera/one/v2/core/RequestBuilder$Factory;Ljava/lang/Runnable;Lcom/android/camera/one/v2/photo/extension/CaptureRequestExtension;Lcom/android/camera/async/BufferQueue;Lcom/android/camera/one/v2/sharedimagereader/ManagedImageReader;Lcom/android/camera/one/v2/sharedimagereader/ManagedImageReader;Lcom/android/camera/one/v2/sharedimagereader/metadatasynchronizer/MetadataPool;Lcom/android/camera/one/v2/core/ResponseManager;IILcom/android/camera/one/OneCameraCaptureSetting;)Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;
    ...
    .line 84
    .local v19, "autoFlashZslImageFilter":Lcom/android/camera/one/v2/photo/zsl/AutoFlashZslImageFilter;
    ...
    .line 89
    new-instance v29, Lcom/android/camera/one/v2/photo/SceneDetectorStub;

    invoke-direct/range {v29 .. v29}, Lcom/android/camera/one/v2/photo/SceneDetectorStub;-><init>()V

    .line 91
    .local v29, "sceneDetector":Lcom/android/camera/one/v2/photo/SceneDetector;
    ...
    invoke-virtual/range {p18 .. p18}, Lcom/android/camera/one/OneCameraCaptureSetting;->getBeautyLevelSetting()Lcom/android/camera/async/Observable;
    ...
    new-instance v6, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;
    ...
    invoke-direct {v6, v0, v1, v2}, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;-><init>(Lcom/android/camera/one/v2/photo/PictureTakerImpl;Lcom/android/camera/one/v2/photo/SceneDetector;Lcom/android/camera/one/v2/photo/FlashDetector;)V

    return-object v6

    .line 92
    .end local v4    # "beautyCaptureCommand":Lcom/android/camera/one/v2/photo/ImageCaptureCommand;
...
.method public provideFlashDetector()Lcom/android/camera/one/v2/photo/FlashDetector;
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;->mFlashDetector:Lcom/android/camera/one/v2/photo/FlashDetector;
...
.method public providePictureTaker()Lcom/android/camera/one/v2/photo/PictureTaker;
    ...
    .prologue
    .line 101
    iget-object v0, p0, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;->mPictureTaker:Lcom/android/camera/one/v2/photo/PictureTakerImpl;
...
.method public provideSceneDetector()Lcom/android/camera/one/v2/photo/SceneDetector;
    ...
    .prologue
    .line 106
    iget-object v0, p0, Lcom/android/camera/one/v2/photo/BeautyPictureTakerFactory;->mSceneDetector:Lcom/android/camera/one/v2/photo/SceneDetector;
