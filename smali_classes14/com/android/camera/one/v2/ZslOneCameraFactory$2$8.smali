.class Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;
...
# direct methods
.method constructor <init>(Lcom/android/camera/one/v2/ZslOneCameraFactory$2;Lcom/android/camera/async/Observable;Lcom/android/camera/async/Observable;Lcom/android/camera/async/Observable;Lcom/android/camera/async/Observable;)V
    .locals 0
    .param p1, "this$1"    # Lcom/android/camera/one/v2/ZslOneCameraFactory$2;

    .prologue
    .line 940
    iput-object p1, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->this$1:Lcom/android/camera/one/v2/ZslOneCameraFactory$2;

    iput-object p2, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$availableImageCount:Lcom/android/camera/async/Observable;

    iput-object p3, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$slaveAvailableImageCount:Lcom/android/camera/async/Observable;

    iput-object p4, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$frameServerAvailability:Lcom/android/camera/async/Observable;

    iput-object p5, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$slaveFrameServerAvailability:Lcom/android/camera/async/Observable;
...
.method public get()Ljava/lang/Boolean;
    ...
    .line 943
    iget-object v4, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$availableImageCount:Lcom/android/camera/async/Observable;
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$slaveAvailableImageCount:Lcom/android/camera/async/Observable;
    ...
    :goto_1
    iget-object v4, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$frameServerAvailability:Lcom/android/camera/async/Observable;
    ...
    iget-object v4, p0, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->val$slaveFrameServerAvailability:Lcom/android/camera/async/Observable;
...
.method public bridge synthetic get()Ljava/lang/Object;
    ...
    .prologue
    .line 940
    invoke-virtual {p0}, Lcom/android/camera/one/v2/ZslOneCameraFactory$2$8;->get()Ljava/lang/Boolean;
