.class Lcom/android/camera/captureintent/state/StateReadyForRecord$12;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "<",
        "Lcom/android/camera/captureintent/event/EventRecordStarting;",
        ">;"
    }
.end annotation
...
.method constructor <init>(Lcom/android/camera/captureintent/state/StateReadyForRecord;)V
    ...
    .prologue
    .line 355
    iput-object p1, p0, Lcom/android/camera/captureintent/state/StateReadyForRecord$12;->this$0:Lcom/android/camera/captureintent/state/StateReadyForRecord;
...
# virtual methods
.method public processEvent(Lcom/android/camera/captureintent/event/EventRecordStarting;)Lcom/google/common/base/Optional;
    .locals 2
    .param p1, "event"    # Lcom/android/camera/captureintent/event/EventRecordStarting;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/android/camera/captureintent/event/EventRecordStarting;",
    ...
    .prologue
    .line 358
    iget-object v0, p0, Lcom/android/camera/captureintent/state/StateReadyForRecord$12;->this$0:Lcom/android/camera/captureintent/state/StateReadyForRecord;
    ...
    new-instance v1, Lcom/android/camera/captureintent/state/StateReadyForRecord$12$1;

    invoke-direct {v1, p0}, Lcom/android/camera/captureintent/state/StateReadyForRecord$12$1;-><init>(Lcom/android/camera/captureintent/state/StateReadyForRecord$12;)V
...
.method public bridge synthetic processEvent(Lcom/android/camera/captureintent/stateful/Event;)Lcom/google/common/base/Optional;
    ...
    .prologue
    .line 355
    check-cast p1, Lcom/android/camera/captureintent/event/EventRecordStarting;

    invoke-virtual {p0, p1}, Lcom/android/camera/captureintent/state/StateReadyForRecord$12;->processEvent(Lcom/android/camera/captureintent/event/EventRecordStarting;)Lcom/google/common/base/Optional;
