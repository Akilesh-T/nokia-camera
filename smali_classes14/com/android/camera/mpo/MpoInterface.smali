...
.method public static readMpo(Ljava/lang/String;)Lcom/android/camera/mpo/MpoData;
    ...
    new-instance v8, Lcom/android/camera/mpo/MpoReader;

    invoke-direct {v8}, Lcom/android/camera/mpo/MpoReader;-><init>()V

    .line 107
    .local v8, "reader":Lcom/android/camera/mpo/MpoReader;
    :try_start_0
    ...
    :try_start_1
    new-instance v7, Lcom/android/camera/mpo/MpoImageData;
    ...
    invoke-direct {v7, v11, v12, v13}, Lcom/android/camera/mpo/MpoImageData;-><init>([BILjava/nio/ByteOrder;)V

    .line 109
    .local v7, "primary":Lcom/android/camera/mpo/MpoImageData;
    invoke-virtual {v8, v4, v7}, Lcom/android/camera/mpo/MpoReader;->parsePrimary(Ljava/io/InputStream;Lcom/android/camera/mpo/MpoImageData;)V

    .line 110
    invoke-static {v4}, Lcom/android/camera/mpo/MpoInterface;->closeSilently(Ljava/io/Closeable;)V

    .line 112
    invoke-virtual {v5, v7}, Lcom/android/camera/mpo/MpoData;->addPrimaryImage(Lcom/android/camera/mpo/MpoImageData;)V

    .line 115
    sget v11, Lcom/android/camera/mpo/MpoInterface;->TAG_MP_ENTRY:I

    int-to-short v11, v11

    const/4 v12, 0x1

    invoke-virtual {v7, v11, v12}, Lcom/android/camera/mpo/MpoImageData;->getTag(SI)Lcom/android/camera/mpo/MpoTag;
    ...
    .line 122
    .local v9, "subimages":Ljava/util/List;, "Ljava/util/List<Lcom/android/camera/mpo/MpoImageData;>;"
    if-eqz v9, :cond_2
    ...
    .line 125
    .local v6, "mpoimage":Lcom/android/camera/mpo/MpoImageData;
    invoke-virtual {v6}, Lcom/android/camera/mpo/MpoImageData;->isJPGFormat()Z
    ...
    .line 126
    invoke-virtual {v8, v6}, Lcom/android/camera/mpo/MpoReader;->parseSubImage(Lcom/android/camera/mpo/MpoImageData;)V
    :try_end_1
    ...
    .end local v2    # "i":I
    .end local v6    # "mpoimage":Lcom/android/camera/mpo/MpoImageData;
    :cond_2
    move-object v3, v4
    ...
    .end local v7    # "primary":Lcom/android/camera/mpo/MpoImageData;
    .end local v9    # "subimages":Ljava/util/List;, "Ljava/util/List<Lcom/android/camera/mpo/MpoImageData;>;"
