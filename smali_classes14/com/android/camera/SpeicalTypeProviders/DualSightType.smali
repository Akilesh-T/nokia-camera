.class public Lcom/android/camera/SpeicalTypeProviders/DualSightType;
...
.method private constructor <init>(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lcom/android/camera/SpeicalTypeProviders/DualSightType;->mKey:Ljava/lang/String;

    .line 31
    iput-object p1, p0, Lcom/android/camera/SpeicalTypeProviders/DualSightType;->mXmpDirectories:Ljava/util/List;

    .line 32
    return-void
.end method

.method public static createFromXMPMetadata(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/camera/SpeicalTypeProviders/DualSightType;
    .locals 5
    ...
    .line 39
    .local v0, "dualSightType":Lcom/android/camera/SpeicalTypeProviders/DualSightType;
    :try_start_0
    ...
    new-instance v0, Lcom/android/camera/SpeicalTypeProviders/DualSightType;

    .end local v0    # "dualSightType":Lcom/android/camera/SpeicalTypeProviders/DualSightType;
    invoke-direct {v0, v3}, Lcom/android/camera/SpeicalTypeProviders/DualSightType;-><init>(Ljava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 47
    .restart local v0    # "dualSightType":Lcom/android/camera/SpeicalTypeProviders/DualSightType;
    if-eqz v1, :cond_0
...
.method public getXMPDualSightKey()Ljava/lang/String;
    ...
    .prologue
    .line 54
    iget-object v3, p0, Lcom/android/camera/SpeicalTypeProviders/DualSightType;->mKey:Ljava/lang/String;

    if-nez v3, :cond_1

    .line 55
    iget-object v3, p0, Lcom/android/camera/SpeicalTypeProviders/DualSightType;->mXmpDirectories:Ljava/util/List;
    ...
    iput-object v4, p0, Lcom/android/camera/SpeicalTypeProviders/DualSightType;->mKey:Ljava/lang/String;
    :try_end_0
