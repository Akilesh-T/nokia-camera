...
.method public extractFiles(Ljava/util/ArrayList;Ljava/lang/String;Lnet/lingala/zip4j/model/UnzipParameters;)V
    .locals 6
    .param p2, "destPath"    # Ljava/lang/String;
    .param p3, "unzipParameters"    # Lnet/lingala/zip4j/model/UnzipParameters;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ">;",
            "Ljava/lang/String;",
            "Lnet/lingala/zip4j/model/UnzipParameters;",
            ")V"
        }
    .end annotation
    ...
    .prologue
    .line 677
    .local p1, "sourceFileList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lnet/lingala/zip4j/model/FileHeader;>;"
    if-nez p1, :cond_0

    .line 678
    new-instance v1, Lnet/lingala/zip4j/exception/ZipException;

    const-string v2, "sourceFileList is null or empty, cannot extract file"
    ...
    .line 701
    .local v0, "unzip":Lnet/lingala/zip4j/unzip/Unzip;
    iget-object v4, p0, Lnet/lingala/zip4j/core/ZipFile;->progressMonitor:Lnet/lingala/zip4j/progress/ProgressMonitor;

    iget-boolean v5, p0, Lnet/lingala/zip4j/core/ZipFile;->runInThread:Z
    ...
    invoke-virtual/range {v0 .. v5}, Lnet/lingala/zip4j/unzip/Unzip;->extractFiles(Ljava/util/ArrayList;Ljava/lang/String;Lnet/lingala/zip4j/model/UnzipParameters;Lnet/lingala/zip4j/progress/ProgressMonitor;Z)V
